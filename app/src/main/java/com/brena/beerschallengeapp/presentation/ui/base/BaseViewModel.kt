...
abstract class BaseViewModel<T> : ViewModel() {
    ...
    private val _isCloseSession = MutableLiveData<Boolean>()
    val closeSession: LiveData<Boolean>
    get() = _isCloseSession
    ...
    protected fun handleUseCaseFailureFromBase(failure: Failure){
        when(failure) {
            is Failure.UnauthorizedOrForbidden -> setError("Log out. Expired Session") /* Log out of the app*/
